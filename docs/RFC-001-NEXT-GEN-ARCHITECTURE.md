...
architecture: forms/Validatable, full i18n message bundles + RTL keymap
flipping, remaining playgrounds (benchmarks with live render metrics), and
migrating the gen-1 routes to the next-gen primitives.
